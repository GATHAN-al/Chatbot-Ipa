...
const HomePage = ({ setActivePage }) => {
  // 8 Topik Populer Sesuai Gambar Referensi Anda (Warna Teks & Border Mengikuti Aturan Tim)
  const topikPopuler = [
    { id: "organ", label: "🫀 Organ Tubuh Manusia" },
    { id: "tumbuhan", label: "🌱 Tumbuhan & Fotosintesis" },
    { id: "ekosistem", label: "🐾 Hewan & Ekosistem" },
    { id: "benda", label: "📦 Benda & Sifatnya" },
    { id: "gaya", label: "⚡ Gaya & Gerak" },
    { id: "cahaya", label: "🔦 Cahaya & Optik" },
    { id: "tatasurya", label: "🪐 Sistem Tata Surya" },
    { id: "lingkungan", label: "🪵 Daur Air & Lingkungan" }
  ];
  ...
  return (
    ...
    <div className="flex-1 bg-[#F5F0E8] overflow-y-auto font-['Nunito'] text-[#2C1A0E]">
      ...
      {/* 1. HERO SECTION (MENGGUNAKAN WARNA AKSEN UTAMA TIM: OLIVE GREEN #7A8C5C) */}
      ...
      <div className="p-6 sm:p-8 max-w-6xl mx-auto space-y-8">
        ...
        {/* 2. TOPIK IPA POPULER (GRID KARTU OFF-WHITE #FAF7F2) */}
        ...
        {/* 3. BANNER KUIS HARIAN (MENGGUNAKAN GRADASI WARNA ORANGE/AMBER TIM: #C4621D) */}
        ...
        <div className="pt-4 text-center space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-[#FAF7F2] p-5 border border-[#D6CFC4] rounded-2xl text-center shadow-sm space-y-2">
              ...
              <p className="text-[11px] text-[#6B5C4E] leading-relaxed">Tanya apapun tentang IPA and dapatkan jawaban mudah dipahami dengan bahasa yang asyik.</p>
            </div>
            <div className="bg-[#FAF7F2] p-5 border border-[#D6CFC4] rounded-2xl text-center shadow-sm space-y-2">
              <span className="text-2xl block">🏆</span>
